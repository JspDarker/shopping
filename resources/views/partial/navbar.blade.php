<nav class="navbar solid dark">
    <div class="navbar-header">
        <div class="basic-wrapper">
            <div class="navbar-brand"> <a href="index.html"><img src="#" srcset="hot/style/images/logo.png 1x, hot/style/images/logo@2x.png 2x" class="logo-light" alt="" /><img src="#" srcset="hot/style/images/logo-dark.png 1x, hot/style/images/logo-dark@2x.png 2x" class="logo-dark" alt="" /></a> </div>
    ...
    <div class="collapse navbar-collapse">
        <ul class="nav navbar-nav">
            ...
            <li class="dropdown"><a href="#" class="dropdown-toggle js-activated" data-toggle="dropdown">Colors <span class="caret"></span></a>
                <ul class="dropdown-menu">
            ...
            <li class="current dropdown"><a href="#" class="dropdown-toggle js-activated" data-toggle="dropdown">Blog <span class="caret"></span></a>
                <ul class="dropdown-menu">
